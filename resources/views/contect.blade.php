                                ...
                                <div class="row" id="service">
                                    <div class="col-md-6 col-12">
                                        <div class="design-check">
                                            ...
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="Product Design"
                                                       id="product_design">
                                                <label class="form-check-label" for="product_design"> Product Design
                                                    (UI/UX)</label>
                                            </div>
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="Graphics
                                                    Design"
                                                       id="graphics_design">
                                        ...
                                        <div class="application-check">
                                            <p>Application</p>
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="Web Design"
                                                       id="web_desig">
                                                <label class="form-check-label" for="web_desig">Web Design</label>
                                            </div>
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="Web
                                                    Development"
                                                       id="web_development">
                                            ...
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="CMS Solution"
                                                       id="cms_solution">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="digital-check">
                                            ...
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="Social Media
                                                    Management"
                                                       id="social_media">
                                            ...
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="SEO"
                                                       id="advance_seo">
                                                <label class="form-check-label" for="advance_seo">Advanced Search Engine
                                                    Optimization (SEO)</label>
                                            </div>
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="Advertising
                                                    Support"
                                                       id="advertising">
                                            ...
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="Campaign
                                                    Management"
                                                       id="campaign">
                                            ...
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="Event Management"
                                                       id="event">
                                                <label class="form-check-label" for="event">Event Management</label>
                                            </div>
                                            <div class="form-check mt-2">
                                                <input class="form-check-input check-box" type="checkbox" value="Competition
                                                    Tracking"
                                                       id="Competition">
                                            ...
                                            <div class="form-check mt-2">
                                                <input class="form-check-input other-box" type="checkbox" value="Other"
                                                       id="Other">
                            ...
                            <div class="contect-none" id="conetctarea">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="group-input">
                                            <select class="country-code" name="country_code">
                                                ...
                                                <option data-countryCode="BD" selected value="880">BD (+880)</option>
                                    ...
                                    <div class="col-sm-3 input-field">
                                        <div class="me-4">
                                            <select class="company" name="company_type">
                                                <option name="" >Type of Company</option>
                                ...
                                <div class="nav d-flex justify-content-between py-4" id="nav-tab" role="tablist">
                                    ...
                                    <div class="skip-next-area">
                                        ...
                                        <button class=" btn-next" onclick="leststep()" id="btnsubmit" type="button">
                                            Submit
                                        </button>
                                    </div>
                                </div>
